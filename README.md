...
| `npm run test:authoring-forms` | the 6 Observation+Pattern authoring schemas (default valid, form↔seed round-trips, client rejects, canonical mutation catches, preview adapters + answer secrecy) |
